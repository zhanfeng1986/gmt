...
static struct Gmt_moduleinfo g_core_module[] = {
	...
	{"grdgdal", "grdgdal", "core", "Execute raster GDAL programs from GMT", "<D{,<G(,GG}"},
	...
	{"grdscan", "grdscan", "core", "Extract unique points per row or col", "<G{,DD}"},
	...
	{"grdgdal", "grdgdal", "core", "Execute raster GDAL programs from GMT", "<D{,<G(,GG}", &GMT_grdgdal},
	...
	{"grdscan", "grdscan", "core", "Extract unique points per row or col", "<G{,DD}", &GMT_grdscan},
